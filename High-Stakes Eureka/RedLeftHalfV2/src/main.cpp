...
Intake.spin(forward);
Drivetrain.turnFor(left,32,degrees);  //was 43
Drivetrain.setDriveVelocity(30, percent); //was 30
Drivetrain.driveFor(forward, 15, inches);  //was 15
Drivetrain.driveFor(reverse, 58, inches);
ClampA.set(false);
...
void pre_auton() {
  ...
  while(!auto_started){
     color detectedColor = ColorS.rgb();
    ...
    Brain.Screen.printAt(5, 120, "On Skib, That's Kinda Sus");
